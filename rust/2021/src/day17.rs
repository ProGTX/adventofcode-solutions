...
fn main() {
    ...
    aoc::expect_result!(45, solve_case1(&example));
    let input = parse("day17.input");
    aoc::expect_result!(5565, solve_case1(&input));

    println!("Part 2");
    aoc::expect_result!(112, solve_case2(&example));
    aoc::expect_result!(2118, solve_case2(&input));
}
